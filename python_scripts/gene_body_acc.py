...
if __name__ == "__main__":
    ...
    annot_cut = annot_file.each(keep_nfeatures, 6).saveas()
    ...
    if args.norm != None:
        ...
        try:
            ...
            sys.exit(-2)
        final_set = read_bed_file(bed_base_sorted)
        final_gene_body_score = final_set.groupby(g=[1,2,3,4,5],c=6, o=['count']).saveas()
    ...
    if args.o != None:
        ...
        with open(args.o, 'a+') as f:
            for read in final_gene_body_score:
                #final = [read[3], read[4], str(read[5])]
                f.write('\t'.join(final))
                f.write('\n')

    elif args.o == None:
        for read in final_gene_body_score:
            print(read[3], read[4], str(read[5]))
