...
if __name__ == "__main__":
    ...
    bed_file = bed_file_filtered.truncate_to_chrom(generate_genome_index_dic).saveas()
    ...
    if len(args.exl) > 1:
        ...
        take_first_bed = exclusion_regions[0]
        merged_exclusion_regions = take_first_bed.sort().saveas(exclude_bed)
   
    shuffled_regions = generate_shuffled_features(bed_file, args.gni, args.gn,
            exclude_bed, mean_gc_score).sort().saveas(args.o + "null_regions.bed")
