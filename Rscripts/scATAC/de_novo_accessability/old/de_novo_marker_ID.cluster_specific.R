...
final_cluster_list <- (unique(loaded_meta_data$V2_annotation_n))
message("Finding DA genes for the Following Clusters:")
print(final_cluster_list)
test <- lapply(final_cluster_list, wrapper_function, meta_data = loaded_meta_data, sparse_matrix=loaded_sparse_matric,  marker_bed = marker_genes, 
               column_name = "V2_annotation_n", all_bed = all_genes, output_base = output_base)
